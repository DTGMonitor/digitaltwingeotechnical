...
export function CTA(){return <section className="grid-bg grid-drift border-t hairline"><div className="shell py-24 md:py-32"><p className="eyebrow">Transform the signal</p><h2 className="headline mt-7 max-w-5xl">Ready to turn integrated data into informed decisions?</h2><Link className="button mt-9" href="/contact">Initiate a conversation <ArrowUpRight size={14}/></Link></div></section>}
