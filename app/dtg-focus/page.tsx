...
export const metadata: Metadata = {
  ...
  description:
    "DTG Focus is DTG's own monitoring software — built and running, used by DTG engineers every day. Your sources in one view: integration, analytics, review and workflow, governance and reporting, and portfolio visibility across sites.",
};
